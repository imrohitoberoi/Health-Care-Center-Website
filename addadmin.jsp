...
<section class="mail pt-lg-5 pt-4">
 <div class="container pt-lg-5">
  <h2 class="heading text-center mb-sm-5 mb-4">Add Admin </h2>
       ...
       try
         {
            ...
            try//TRY BLOCK IS VERY IMP SINCE WITHOUT THIS IF ERROR COMES,THE APPLCATION CRASHES
            {
                    ...
                    myst.setString(6,"admin"); //IT IS SIMILAR TO NORMAL SIGNUP, THE ONLY DIFFERENCE IS THAT HERE USERTYPE IS "admin" WHICH BRINGS US TO ADMIN HOME PAGE WHEN WE LOGIN
