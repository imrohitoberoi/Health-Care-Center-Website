...
<section class="mail pt-lg-5 pt-4">
 <div class="container pt-lg-5">
  <h2 class="heading text-center mb-sm-5 mb-4">Add User </h2>
	...
	<div class="form-group">
	<input type="text" name="uname" class="form-control" placeholder="Username" required=""> <!YOU CAN ALSO ADD RADIO BUTTONS FOR GENDER>
	</div>
	</div>
	<div class="col-md-12">
	<div class="form-group">
       ...
       try
         {
            ...
            myst.setString(6,"member"); //IT IS SIMILAR TO NORMAL SIGNUP, THE ONLY DIFFERENCE IS THAT HERE USERTYPE IS "admin" WHICH BRINGS US TO ADMIN HOME PAGE WHEN WE LOGIN
