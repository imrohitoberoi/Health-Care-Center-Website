...
<h2 class="heading text-center mb-sm-5 mb-4">List of Admins</h2>
                            ...
                            {    //IMP- HERE NOW CURSOR IS AT FIRST LINE/ROW OF OUR DATABASE AND WE CAN CALL ANY COLUMN USNG myres.getString("column name");
                                out.print("</tr>"
                                        + "<th>" + myres.getString("name") + "</th>"//myres.getString("column name")- GIVES THE VALUE OF THAT COLUMN AFTER WE ARE CONNECTED TO DATABASE
                                                + "<th>" + myres.getString("Username") + "</th>"
                                                + "<th>" + myres.getString("phonenumber") + "</th>"
                                                        + "<th>" + myres.getString("email") + "</th>"
                                                                        + "<td><a href='updatemem.jsp?uname=" + myres.getString("username") + "' style='color:black'>Update</a></td>"
                                                        + "<td><a href='deletemem.jsp?uname=" + myres.getString("username") + "' style='color:black'>Delete</a></td>");
