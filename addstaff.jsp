...
<section class="mail pt-lg-5 pt-4">
 <div class="container pt-lg-5">
  <h2 class="heading text-center mb-sm-5 mb-4">Add Staff </h2>
	 ...
	 <div class="row">
	  <div class="col-md-6 wthree_contact_left_grid pr-md-0">
	   <div class="form-group">
	    <input type="text" name="name" class="form-control" placeholder="Name" required=""> <!HERE WE ENTER NAME >
	    </div>
	    <div class="form-group">
	...
	<input type="text" name="qualification" class="form-control" placeholder="Qualification" required="">
             ...
             <div class="col-md-6 wthree_contact_left_grid">
	<div class="form-group">
	<input type="text" name="address" class="form-control" placeholder="Address" required=""> <!YOU CAN ALSO ADD RADIO BUTTONS FOR GENDER>
	</div>
       ...
       try
         {
            ...
            String q="insert into staff(name,email,phone,gender,qualification,address,type) values(?,?,?,?,?,?,?)";//THIS IS QUERY I.E. IT GIVES WHICH FUNCTION TO DO IN OUR DATABASE,HERE IT "INSERTS"
            ...
            myst.setString(2,em);//THESE VALUES ARE INSERTED AT PLACE OF "?" IN OUR QUERY STATEMENT
            myst.setString(3,phn);
            myst.setString(4,gen);
            myst.setString(5,qual);
            myst.setString(6,add); //IT IS SIMILAR TO NORMAL SIGNUP, THE ONLY DIFFERENCE IS THAT HERE USERTYPE IS "admin" WHICH BRINGS US TO ADMIN HOME PAGE WHEN WE LOGIN
